    ...
    <div class="card shadow rounded" style="width: 700px; margin: 50px auto; background:#E6E6FA;">
        <div class="row justify-content-center p-3 my-3">
            <div class="col-lg-10 col-md-10 col-12">
                <h2 class="text-center pt-2 rounded"style="background-color: #ffff; color: #acacac; text-shadow: 1px 3px 3px azure; width: 300px; height:45px; margin: 2px auto 0; font-size: 22px; font-weight: 700 !important;">Daftar Akun Driver</h2>
                <div class="py-3"><br>
                    <form action="<?php echo base_url('Driver/register') ?>" method="post">
                        <div class="row">
                            <div class="mb-2 col">
                            ...
                            <div class="mb-2 col">
                                ...
                                <select name="jns_kel" id="jns_kel" class="form-select">
