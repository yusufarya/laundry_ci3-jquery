...
class BaseController extends CI_Controller 
{
	...
	function loadViewsD($viewName = "", $headerInfo = NULL, $pageInfo = NULL, $footerInfo = NULL, $clickMenu = TRUE)
    {
        $header = BASE_DIR."application/views/templatesDriver/header.php";
		if ($clickMenu == FALSE) {
			$nav = BASE_DIR."application/views/templatesDriver/nav_disabled.php";
		} else {
			$nav = BASE_DIR."application/views/templatesDriver/sidebar.php";
		}
		$topbar = BASE_DIR."application/views/templatesDriver/topbar.php";
		$footer = BASE_DIR."application/views/templatesDriver/footer.php";
		$scripts = BASE_DIR."application/views/templatesDriver/scripts.php";
